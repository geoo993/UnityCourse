...
public class TextController : MonoBehaviour
{
    ...
    void cell()
    {
        ...
        text.text = "You are in a prisoner cell, and you want to escape. The are " +
                    "some dirty sheets on the bed, a mirror on the wall, and the door " +
                    "is locked from the outside.\n\n" +
                    "Press S to view Sheets, M to view Mirror and L to Lock.";
    ...
    void sheet_0()
    {
        text.text = "You can't believe you sleep in these things. Surely it's " +
                    "time somebody changes them. The pleasures of prison life " +
                    "I guess.\n\n" +
